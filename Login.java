...
//SWING组件：JDK.4推出的图形界面类
import javax.swing.JFrame;  //JFrame:窗体容器组件类（顶级容器）
import javax.swing.JLabel;  //标签元素类：显示文字/图片
import javax.swing.JTextField;  //文本输入框元素组件类：接收用户输入的信息，直接显示出来
import javax.swing.JPasswordField;  //密码输入框组件类：接收用户输入的信息，用加密符显示出来
import javax.swing.JButton;  //按键元素组件类：显示文字/图片（可点击）
...
public class Login {
  ...
  //在类中定义初始化界面的方法
    public void initUI() {
        ...
        //设置窗体对象的属性值：标题、大小、显示位置、关闭操作、布局、禁止调整大小、可见、...
        frame.setTitle("自助提款机");// 设置窗体的标题
